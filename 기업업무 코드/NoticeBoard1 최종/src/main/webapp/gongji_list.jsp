...
<body>
	...
	ResultSet rset = stmt.executeQuery("select id, title, date from gongji"); // gongji테이블에서 id, title, date 출력
	...
	<form method="post"> <%-- 데이터 제출하는 form태그 --%>
		<table>
			<tr>
				<td class="one">번호</td> <%-- 번호 --%>
				<td class="seven" style="text-align: center;">제목</td> <%-- 제목 --%>
				<td class="two">등록일</td> <%-- 등록일 --%>
			</tr>
		...
		<table style="border:0px">
			<tr><td style="border:0px; text-align:right;"><input type="submit" value='신규' formaction="gongji_insert.jsp"></td></tr> <%-- 신규버튼 --%>
		</table>
	</form>
		<table>
			<%
