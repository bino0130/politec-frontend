...
<form method="post" action="product_list.jsp">
	<table>
		...
		<tr>
			<td style="text-align : center;"><div style="margin-bottom : 10px; font-weight: 600;">신규 상품이 등록되었습니다</div>
...
<form method="post" action="product_list.jsp">
	<table>
		...
		<tr>
			<td style="text-align : center;"><div style="margin-bottom : 10px; font-weight: 600;">상품이 수정되었습니다.</div>
										<input type="submit" value="재고 현황"></td>
		</tr>
	</table>
</form>
