			...
			<form method="post" enctype="multipart/form-data">
				<table style="margin-top: 30px; margin-left: 120px;">
					...
					<tr>
						...
						<td><input type="text" name="itemName" maxlength="15" value="" pattern="^(?!\\s+$)(?!.*[<>]).*$" oninput="validateInput(this)" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea id="area" name="itemDescribe" maxlength="600" pattern="^(?!.*[<>]).*$" required></textarea></td>
					</tr>
					<tr>
						<td>상품사진</td>
