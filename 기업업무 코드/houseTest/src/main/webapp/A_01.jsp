...
<body>
	...
	<div
		...
		<!-- border가 1px solid black, 너비는 900, 높이는 800, 마진은 auto인 div태그 -->
		<div id=up>
			<!-- id가 up인 div태그 -->
			...
			<table class="printKiho">
				...
				<form method='post'>
					...
					<tr class='table-row'>
						...
						<!-- deleteID를 전달하는 hidden타입 input태그 -->
						<td><input type='hidden' name='deleteName' value='<%=name%>' /></td>
						<!-- deleteName을 전달하는 hidden타입 input태그 -->
						...
						<!-- A_02 파일에 데이터를 전달하는 삭제 버튼 input태그 -->
					</tr>
					<!-- table row -->
				</form>
				<!--  form 태그 닫힘 -->
