...
<form method="post"> <%-- 데이터 값을 전달하는 form태그 --%>
			<table>
				...
				<tr>
					...
					<td>
						<%-- 재고 현황 출력 --%>
						<input type="text" name="updateCount" oninput="characterCheck(this)" pattern="[1-9][0-9]{0,5}|1000000" title="1부터 100만까지 입력가능" value="<%=itemCount%>" required>
					</td>
				</tr>
				<tr>
			...
			<table style="height:30px; border:0px;">
				<tr>
					<td style="border:0px; text-align:right;">
						...
						<input type="submit" value="재고 수정" formaction="product_write.jsp"> <%-- 재고 수정 버튼, product_write에 데이터 전달 --%>
					</td>
				</tr>
			</table>
	<%
