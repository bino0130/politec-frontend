			...
			<table style="height:30px; border:0px;">
				<tr>
					<td style="border:0px; text-align:right;"> <%-- 오른쪽 정렬 --%>
						...
						<input class="submit" type="submit" value='상품 삭제' formaction="product_delete.jsp"> <%-- 상품 삭제버튼, product_delete에 값 전달 --%>
						<input class="submit" type="submit" value="재고 수정" formaction="product_update.jsp"> <%-- 재고 수정버튼, product_update에 값 전달 --%>
					</td>
				</tr>
			</table>
	<%
