		...
		<table id="up">
			...
			<tr>
				...
				<td class="nine" style="height:30px;">
					<input type="text" name="title" oninput="validateInput(this)" maxlength="20" value="" style="width:400px;" required>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="one">내용</td>
				<td class="nine">
					<textarea name="message" maxlength="600" oninput="validateInput(this)" style="overflow: auto; border: none; resize: none; width: 95%; height: 300px;" required></textarea>
				</td>
			</tr>
			<tr>
				<td>원글</td>
